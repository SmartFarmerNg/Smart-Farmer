...
const CropsSection = ({ crops, cropsLoading }) => {
    ...
    return (
        <section className="w-full max-w-2xl mt-4 p-6 bg-white/30 backdrop-blur-md shadow-lg rounded-2xl border border-gray-200 z-50">
            <input
                type="text"
                ...
                <>
                    <div className="grid grid-cols-1 gap-4 mt-4">
                        {currentCrops.map((data, index) => (
                            ...
                            >
                                <div>
                                    <div className="text-lg text-gray-800 text-start">{data.name}</div>
