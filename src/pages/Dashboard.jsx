import { Banknote, Briefcase, CircleDollarSign } from 'lucide-react';
        ...
        <div className='bg-gradient-to-br from-[#0FA280] to-[#054D3B] text-gray-900 font-sans'>
            <div className='min-h-screen max-w-2xl px-3 flex flex-col items-center mx-auto py-6 pb-20'>
                ...
                <section className="w-full max-w-2xl mt-8 p-6 bg-white/30 backdrop-blur-md shadow-lg rounded-2xl border border-gray-200">
                    <input
                        type="text"
                        className="w-full p-3 bg-gray-100 border border-gray-300 rounded-full text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0FA280] transition-all sticky top-2 z-10"
