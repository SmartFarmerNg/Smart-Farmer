...
const Transact = () => {
    ...
    return (
        <div className='bg-gradient-to-br from-[#0FA280] to-[#054D3B] text-gray-900 font-sans min-h-screen flex flex-col items-center'>
            <div className='w-full max-w-2xl px-4 py-6'>
                ...
                >
                    ...
                    <p className="text-3xl font-bold text-[#0FA280]">NGN {balance.toLocaleString()}</p>
                </motion.div>
                ...
                <div className="mt-6 w-full grid grid-cols-2 gap-4">
                    {["Deposit", "Withdraw"].map((action, index) => (
                        ...
                        >
                            {action === "Deposit" ? <ArrowDownLeft className="text-green-600 w-8 h-8" /> : <ArrowUpRight className="text-red-600 w-8 h-8" />}
